...
def build_nakshatra_block(
    ...
    end_dt = find_nakshatra_end(dt, ayanamsa=ayanamsa)
    ...
    return _enrich_next_anga(
        block,
        sunrise_dt,
        lambda moment: find_nakshatra_end(moment, ayanamsa=ayanamsa),
        27,
        NAKSHATRA_NAMES,
        NAKSHATRA_NAMES_NE,
        timezone_name,
...
def build_yoga_block(
    ...
    return _enrich_next_anga(
        block,
        sunrise_dt,
        lambda moment: find_yoga_end(moment, ayanamsa=ayanamsa),
        27,
        YOGA_NAMES,
        YOGA_NAMES_NE,
        timezone_name,
...
def _karana_name_ne(name: str) -> str:
    from engine.vedic.names_ne import KARANA_NAMES_NE
