...
from core.swiss_eph import _ensure_initialized, get_julian_day, init_ephemeris
...
def compute_belaantar(at: datetime) -> dict[str, Any]:
  ...
  correcting mean solar time toward apparent (true) solar time.
    ...
    # Swiss Ephemeris: local apparent − local mean, in days
    e_days = float(swe.time_equ(jd))
    return {
